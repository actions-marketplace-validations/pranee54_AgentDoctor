...
It also ships **Safety V1**: Scan → Fix → Verify for Cursor, Claude Code, Codex, GitHub Copilot, Windsurf, Gemini CLI, and Aider (see [surfaces-and-adapters.md](../reference/surfaces-and-adapters.md)). Universal hygiene still runs when no agent config is present (see [surfaces-and-adapters.md](../reference/surfaces-and-adapters.md) and [scan-examples.md](scan-examples.md)).

## Who should use it

- Developers using Cursor, Claude Code, Codex, GitHub Copilot, Windsurf, Gemini CLI, or Aider who want repository-level context, not only file search
- Teams that want the same hygiene scan even when no AI agent is configured yet (see [surfaces-and-adapters.md](../reference/surfaces-and-adapters.md))
...
Package: `@praneeth_54/agentdoctor` · CLI: `agentdoctor` · Version: **2.0.0**
...
| [project-brain.md](../features/project-brain.md)      | Brain data model         |
