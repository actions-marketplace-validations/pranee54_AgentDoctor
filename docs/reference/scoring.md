...
`scores` object. Behavior must match this document unless a later `docs/reference/scoring.md`
...
For each of `cursor`, `claude-code`, `codex`, `copilot`, `windsurf`, `gemini-cli`, and `aider`:
