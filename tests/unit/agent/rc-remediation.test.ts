...
describe("P1 ModeProfile.allowWrites enforcement", () => {
  ...
  it(
    "LEARN coding loop stops with mode_forbidden",
    async () => {
  ...
  it(
    "BUILD_WITH_ME / BUILD_FOR_ME / AI_AGENT require human approval",
    async () => {
...
describe("P4 agent limit enforcement", () => {
  ...
  it(
    "stops on maxWallTimeMs without long commands",
    async () => {
  ...
  it(
    "stops before exceeding maxFilesModified",
    async () => {
  ...
  it(
    "truncates model context by maxContextChars",
    async () => {
...
describe("P5 model-driven coding loop", () => {
  it(
    "MODEL→PLAN→approval→tools→verify; model never writes directly",
    async () => {
  ...
  it(
    "blocks dangerous command proposed by model",
    async () => {
...
describe("P6 run-tests path", () => {
  it(
    "EDIT → RUN TESTS pass → VERIFY reports tests",
    async () => {
  ...
  it(
    "EDIT → RUN TESTS fail → VERIFY reports failure without claiming correctness",
    async () => {
...
describe("P11 BUILD_WITH_ME reaches coding loop", () => {
  it(
    "explains and awaits approval, then executes runCodingLoop after approve",
    async () => {
